...
8. **Keep custom spell graphs atomic.** Changing spell 901001 or 901002 requires checking C++ constants/config, server spell rows, script bindings, scaling rows, backend caches, client `Spell.dbc`, collision guards, and documentation.
