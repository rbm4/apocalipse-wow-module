...
| Death Knight Rupture | Every landed melee auto or melee-class ability hit, including a fully absorbed hit, builds a stacking physical bleed | Same through Blood Spec Manager acquisition of passive 901048 | None; existing attacks apply it automatically and no new bot action is required |
...
| Threat of Thassarian extension | Talented dual-wield Heart Strike and Scourge Strike gain independent off-hand attacks; each landed main-hand or off-hand Death Strike heals at 70 percent strength | Same when the bot knows rank 65661, 66191, or 66192 and has a usable off-hand weapon | None; existing strike actions need no change and acquisition remains external |
...
| Bladeguard | A learned passive grants item armor, block chance, 75 percent increased threat from all Rogue-family abilities, and block-triggered Energy only while a usable shield is equipped | Same when the bot has acquired 901073 and equipped a shield | None in mechanics; acquisition and automatic shield selection remain external |
| Shielded Reflexes | A shield block grants at least six seconds of stock Evasion and Blade Flurry on a 30-second internal cooldown | Same when the bot has acquired 901158 and equipped a usable shield | None in mechanics; no cast action is required, while acquisition and automatic shield selection remain external |
| Buckler Strike | Twenty-second shield strike deals 110 percent AP plus block-value Physical damage, guarantees stock Blade Twisting on successful hits, awards one combo point, generates high threat, and interrupts non-player casting | Same when the bot has acquired 901078 and equipped a usable shield | Mechanics are identical; acquisition, shield selection, and active cast policy remain external |
...
| Shaman spell pack | Elemental spread and echoes, stackable level-selected shields, restoration procs, cooldown modifiers, and three active cooldowns | Identical mechanics after external acquisition | Passives reuse existing Shaman actions. Ascension 901094, Stoneguard Bulwark 901115, and Storm Unleashed 901116 require future cast-decision actions. Acquisition is external for the entire pack. |
| Priest ability pack | Shared sustain, Penance interactions, Holy dual-role mechanics, and Shadow periodic mechanics | Identical mechanics after external acquisition | Inner Renewal 901121, Archangel 901129, Apotheosis 901145, and Void Eruption 901153 require cast decisions in the unavailable Priest AI source repository. |
...
| Bot with passive 901158 and a usable shield blocks an attack | Same stock Evasion and Blade Flurry grant, six-second minimum, and 30-second internal cooldown as a human | Not run in this review |
...
| Dual-wield bot with any Threat of Thassarian rank uses Heart Strike, Scourge Strike, and Death Strike | Same rank chance, independent off-hand resolution, Scourge Shadow attribution, and one 70-percent Death Strike heal per landed hand as a human | Not run in this review |
