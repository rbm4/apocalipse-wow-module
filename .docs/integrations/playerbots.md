...
| Threat of Thassarian extension | Talented dual-wield Heart Strike and Scourge Strike gain independent off-hand attacks, while Death Strike keeps one half-strength heal | Same when the bot knows rank 65661, 66191, or 66192 and has a usable off-hand weapon | None; existing strike actions need no change and acquisition remains external |
...
| Dual-wield bot with any Threat of Thassarian rank uses Heart Strike, Scourge Strike, and Death Strike | Same rank chance, independent off-hand resolution, Scourge Shadow attribution, and one half-strength Death Strike heal as a human | Not run in this review |
