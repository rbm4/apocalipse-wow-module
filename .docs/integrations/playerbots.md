...
| Rogue shield proficiency | Default skill loading grants Shield skill 433; rogue-only reward rows grant Shield Proficiency 9116 and Block 107 | Same for bot-controlled rogues | Mechanics are identical; automatic shield selection remains playerbot policy |
