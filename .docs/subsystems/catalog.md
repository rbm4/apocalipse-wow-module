...
| Shielded Reflexes | `src/mod_apocalipse_rogue_shielded_reflexes.cpp`, `data/sql/db-world/2026_09_25_03_shielded_reflexes.sql` | Shield-gated block proc hook | Passive 901158 and one aura-owned 30000 ms cooldown | Reuses stock Evasion 5277, stock Blade Flurry 13877, block resolution, and item-dependent passive lifecycle |
...
| Threat of Thassarian extension | `src/mod_apocalipse_death_knight_threat_of_thassarian.cpp`, baseline and `2026_09_26_01_threat_of_thassarian_healing.sql`, plus deployment-core `spell_dk.cpp` | Additive talent proc and Death Strike heal hooks | Stock ranks 65661, 66191, 66192, off-hand Death Strike rank chain 66188, plus helpers 901156 and 901157 | Reuses stock talent chance, off-hand weapon resolution, Heart Strike chaining, Scourge Strike Shadow composition, and heal 45470 once per landed Death Strike hand at 70 percent strength |
...
- 901156 and 901157: Threat of Thassarian off-hand Scourge Strike and Heart Strike helpers, code constants, automatic world migration, additive stock bindings, extended talent proc masks, backend names, and client DBC.
- 901158: Shielded Reflexes passive, code constant, automatic world migration, shield equipment masks, block-only proc metadata, 30-second internal cooldown, script binding, stock effects 5277 and 13877, backend name, and client DBC.
