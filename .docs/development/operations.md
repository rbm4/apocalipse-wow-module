...
- Relentless Finale initial infinite readiness, one-through-four-point exclusion, player-initiated five-point finisher retention, 5 percent maximum-health healing, immediate normal second-finisher consumption, 12-second post-use recharge, triggered and copied exclusions, cancellation cleanup, passive removal, and identical human/playerbot mechanics.
